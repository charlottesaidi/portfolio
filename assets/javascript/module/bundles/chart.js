export class Dial {
    constructor(container, id) {
      ...
      this.radius = this.size / 4 - this.strokeWidth / 4;
      this.value = this.container.dataset.value;
      this.colorStart = this.container.dataset.start;
      this.colorEnd = this.container.dataset.end;
    ...
    createSvg() {
      ...
      svg.setAttribute("class", `svg_chart`);
      this.svg = svg;
    }
    ...
    createDefs(id) {
      ...
      linearGradient.setAttribute("id", `gradient_${id}`);
      stop1.setAttribute("stop-color", this.colorEnd);
      stop1.setAttribute("offset", "0%");
      linearGradient.appendChild(stop1);
      stop2.setAttribute("stop-color", this.colorStart);
      stop2.setAttribute("offset", "100%");
      linearGradient.appendChild(stop2);
      linearGradientBackground.setAttribute("id", `gradient-background_${id}`);
    ...
    createSlice(id) {
      ...
      slice.setAttribute("stroke", `url(#gradient_${id})`);
    ...
    createOverlay(id) {
      ...
      circle.setAttribute("fill", `url(gradient-background_${id})`);
