...
$(function(){
    ...
    var toggleMobileSwitch = document.getElementById("togMobileButton");

    if(document.querySelector('.container_login')) { 
        var toggleSwitch = document.createElement('input');
        var toggleMobileSwitch = document.createElement('input');
        toggleSwitch.setAttribute('id', 'togButton');
        toggleMobileSwitch.setAttribute('id', 'togMobileButton');
        toggleSwitch.classList.add('hidden');
        toggleMobileSwitch.classList.add('hidden');
     }
    ...
    if(!document.querySelector('.container_login')) {  
        ...
        if(!document.querySelector('.policy_main')) {
